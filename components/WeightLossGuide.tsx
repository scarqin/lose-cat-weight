...
const WeightLossGuide: React.FC<WeightLossGuideProps> = ({ 
  ...
  // 干粮热量密度状态变量
  const [dryFoodCalories, setDryFoodCalories] = useState<number>(DEFAULT_DRY_FOOD_CALORIES);
  const [isEditingDryFoodCalories, setIsEditingDryFoodCalories] = useState<boolean>(false);
  const [tempDryFoodCalories, setTempDryFoodCalories] = useState<string>(dryFoodCalories.toString());
            ...
            <div className="p-4 mb-4 bg-amber-50 rounded-lg border border-amber-100">
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                {isEditingDryFoodCalories ? (
                  ...
                  <div className="flex items-center">
                    <span className="font-medium text-amber-700">{dryFoodCalories} Kcal/g</span>
                    <button
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-amber-700">约 {DEFAULT_WET_FOOD_CALORIES} Kcal/g</span>
              </div>
